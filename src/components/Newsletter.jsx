...
const Newsletter = () => {
  return (
    <div className='md:w-[65%] flex flex-col justify-center items-center m-auto px-[0px] bg-gradient-to-b from-[#fde1ff] via-[#e1ffea22] gap-[30px]'>
        ...
        <div className='flex items-center justify-between bg-white rounded-[80px] border-[1px] border-[#e3e3e3]'>
            ...
            <button className='w-[210px] h-[70px] rounded-[80px] bg-black text-white md:text-[16px]'>Subscribe</button>
        </div>
    </div>
  )
}
